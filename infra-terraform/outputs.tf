...
output "uploaded_lambda_jar_key" {
  description = "S3 key for the uploaded Java Lambda jar."
  value       = aws_s3_object.tinyurl_jar.key
}
...
output "tinyurl_lambda_arn" {
  description = "ARN of the Tinyurl Java Lambda function."
